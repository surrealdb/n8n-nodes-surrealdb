...
export const queryFields: INodeProperties[] = [
  ...
  },
  {
    ...
    description: "Parameters for the query as a JSON object (use $param_name in conditions)",
  },
  {
    displayName: "Options",
    name: "options",
    ...
    options: [
      ...
      },
      {
        ...
        type: "boolean",
        default: false,
        description: "Whether to return the generated SurrealQL query in the output",
      },
    ],
  },
];

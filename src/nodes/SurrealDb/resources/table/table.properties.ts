    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                default: false,
                description:
                    "Whether to return an empty result when the target table does not exist. SurrealDB v3 treats queries against non-existent tables as errors; enable this to preserve the v1.x/v2.x silent-empty behavior.",
            },
            {

                ...
                const indexesArray = Object.entries(
                    ...
                    if (indexType === "mtree") {
                        const dimensionMatch =
                            definitionStr.match(/DIMENSION\s+(\d+)/i);
                    ...
                    if (indexType === "mtree") {
                        ...
                        distanceFunction = distMatch
                            ? distMatch[1].toLowerCase()
                            : null;
                    }
                    ...
                    const hasHighlights =
                        indexType === "search" &&
                        definitionStr.includes(" HIGHLIGHTS");

                    // Extract the analyzer if it's a SEARCH index
                    let analyzer = null;
                    if (indexType === "search") {
                        const analyzerMatch =
                            definitionStr.match(/ANALYZER\s+(\w+)/i);

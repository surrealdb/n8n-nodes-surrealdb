...
export const relationshipFields: INodeProperties[] = [
	// Fields for createRelationship operation
	{
		...
		description: 'The ID of the record to create the relationship from. Must be in the format "table:id"',
		displayOptions: {
			show: {
				resource: [
					'relationship',
	...
	},
	{
		...
		description: 'The type of relationship to create. At least one of From Record ID, Relationship Type, or To Record ID must be provided',
		displayOptions: {
			show: {
				resource: [
					'relationship',
	...
	},
	{
		...
		description: 'The ID of the record to create the relationship to. Must be in the format "table:id"',
		displayOptions: {
			show: {
				resource: [
					'relationship',
	...
	// Fields for deleteRelationship operation
	{
		...
		default: '',
		placeholder: 'e.g., person:john, article:123',
		description: 'The ID of the record to delete the relationship from. Must be in the format "table:id". At least one of From Record ID, Relationship Type, or To Record ID must be provided',
		displayOptions: {
			show: {
				resource: [
					'relationship',
	...
	},
	{
		...
		default: '',
		placeholder: 'e.g., person:jane, product:456',
		description: 'The ID of the record to delete the relationship to. Must be in the format "table:id". At least one of From Record ID, Relationship Type, or To Record ID must be provided',
		displayOptions: {
			show: {
				resource: [
					'relationship',
	...
	// Fields for queryRelationships operation
	{
		...
		default: '',
		placeholder: 'e.g., person:john, article:123',
		description: 'The ID of the record to query relationships for. Must be in the format "table:id". Leave empty to query all relationships of the specified type',
		displayOptions: {
			show: {
				resource: [
					'relationship',
	...
	},
	{
		...
		default: '',
		placeholder: 'e.g., knows, likes, wrote',
		description: 'The type of relationship to query (leave empty to query all relationship types)',
		displayOptions: {
			show: {
				resource: [
					'relationship',
	...
	// Options collection for all relationship operations
	{
		...
		options: [
				...
				options: [
					{
						name: 'After',
						value: 'AFTER',
						description: 'Return the record after changes were applied (default)',
					},
					{
						name: 'Before',
						value: 'BEFORE',
						description: 'Return the record before changes were applied',
					},
					{
						name: 'Diff',
						value: 'DIFF',
						description: 'Return the difference between the record before and after changes',
					},
					{
						name: 'None',
						value: 'NONE',
			...
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Return a single object instead of an array with a single object',
				displayOptions: {
					show: {
						'/operation': [
							'createRelationship',
			...
			},
			{
				...
				description: 'The target table to filter relationships to (for queryRelationships)',
				displayOptions: {
					show: {
						'/operation': [
							'queryRelationships',
			...
			},
			{
				...
				type: 'boolean',
				default: true,
				description: 'Whether to include relationship properties in the query results',
				displayOptions: {
					show: {
						'/operation': [
							'queryRelationships',
			...
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Whether to return each relationship as a separate item or all relationships as a single item with an array property',
				displayOptions: {
					show: {
						'/operation': [
							'queryRelationships',
